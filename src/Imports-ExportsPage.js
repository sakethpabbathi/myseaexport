...
//             <a onClick={() => handleNavClick("home")} style={navStyles.navLink}>Home</a>
//             <a onClick={() => handleNavClick("imports-exports", 1, ["Imports"])} style={navStyles.navLink}>Import</a>
//             <a onClick={() => handleNavClick("imports-exports", 6, ["Exports"])} style={navStyles.navLink}>Export</a>
//             <a onClick={() => handleNavClick("about")} style={navStyles.navLink}>About us</a>
//             <a onClick={() => handleNavClick("contact")} style={navStyles.navLink}>Contact</a>
//           </nav>
//         )}
//       </div>
//     </header>
...
//   // Fix for Mobile Scrolling: Relative positioning for active slides
